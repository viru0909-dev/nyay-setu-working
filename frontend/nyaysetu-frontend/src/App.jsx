  ...
  lazy(async () => {
    ...
    try {
      ...
      if (!pageHasAlreadyBeenForceRefreshed) {
        ...
        return {
          default: () => (
            <LoadingSpinner fullScreen message="Syncing workspace patches..." />
          ),
        };
      }
      throw error;
...
const LawyerDashboard = retryLazy(
  () => import("./pages/dashboards/LawyerDashboard"),
);

// Litigant Pages
const LitigantDashboard = retryLazy(
  () => import("./pages/litigant/LitigantDashboard"),
);
const FileUnifiedPage = retryLazy(
  () => import("./pages/litigant/FileUnifiedPage"),
);
const VakilFriendPage = retryLazy(
  () => import("./pages/litigant/VakilFriendPage"),
);
const CaseDiaryPage = retryLazy(() => import("./pages/litigant/CaseDiaryPage"));
const CaseDetailPage = retryLazy(
  () => import("./pages/litigant/CaseDetailPage"),
);
const HearingsPage = retryLazy(() => import("./pages/litigant/HearingsPage"));
const LawyerChatPage = retryLazy(
  () => import("./pages/litigant/LawyerChatPage"),
);
const ProfilePage = retryLazy(() => import("./pages/litigant/ProfilePage"));
const DocumentGeneratePage = retryLazy(
  () => import("./pages/litigant/DocumentGeneratePage"),
);
const FindLawyerPage = retryLazy(
  () => import("./pages/litigant/FindLawyerPage"),
);
const LawyerFeedbackPage = retryLazy(
  () => import("./pages/litigant/LawyerFeedbackPage"),
);

// Judge Pages
const ConductHearingPage = retryLazy(
  () => import("./pages/judge/ConductHearingPage"),
);
const CourtAnalyticsPage = retryLazy(
  () => import("./pages/judge/CourtAnalyticsPage"),
);
const MyDocket = retryLazy(() => import("./pages/judge/MyDocket"));
const JudgeCaseWorkspace = retryLazy(
  () => import("./pages/judge/JudgeCaseWorkspace"),
);
const JudicialOverview = retryLazy(
  () => import("./pages/judge/JudicialOverview"),
);
...
const JudgeHearingsPage = retryLazy(
  () => import("./pages/judge/JudgeHearingsPage"),
);

// Lawyer Pages
const LawyerCasesPage = retryLazy(
  () => import("./pages/lawyer/LawyerCasesPage"),
);
const MyClientsPage = retryLazy(() => import("./pages/lawyer/MyClientsPage"));
const CasePreparationPage = retryLazy(
  () => import("./pages/lawyer/CasePreparationPage"),
);
const EvidenceVaultPage = retryLazy(
  () => import("./pages/lawyer/EvidenceVaultPage"),
);
const AILegalAssistantPage = retryLazy(
  () => import("./pages/lawyer/AILegalAssistantPage"),
);
const LawyerHearingsPage = retryLazy(
  () => import("./pages/lawyer/LawyerHearingsPage"),
);
const LawyerAnalyticsPage = retryLazy(
  () => import("./pages/lawyer/AnalyticsPage"),
);
const LawyerCaseDetailsPage = retryLazy(
  () => import("./pages/lawyer/LawyerCaseDetailsPage"),
);
const ClientChatPage = retryLazy(() => import("./pages/lawyer/ClientChatPage"));
const LawyerProfilePage = retryLazy(
  () => import("./pages/lawyer/LawyerProfilePage"),
);
const CaseWorkspace = retryLazy(() => import("./pages/lawyer/CaseWorkspace"));
const OfflineDraftsPage = retryLazy(
  () => import("./pages/lawyer/OfflineDraftsPage"),
);

// Police Pages
const PoliceDashboard = retryLazy(
  () => import("./pages/police/PoliceDashboard"),
);
const UploadFirPage = retryLazy(() => import("./pages/police/UploadFirPage"));
const MyFirsPage = retryLazy(() => import("./pages/police/MyFirsPage"));
const PoliceInvestigationsPage = retryLazy(
  () => import("./pages/police/PoliceInvestigationsPage"),
);
const InvestigationDetailsPage = retryLazy(
  () => import("./pages/police/InvestigationDetailsPage"),
);
      ...
      <ErrorBoundary>
        <LanguageProvider>
          ...
          >
            ...
            <Suspense
              fallback={
                <LoadingSpinner fullScreen message="Loading NyaySetu..." />
              }
            >
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <ProtectedWorkspace
                      allowedRoles={["LITIGANT"]}
                      message="Loading Litigant Workspace..."
                    >
                      <DashboardLayout />
                    </ProtectedWorkspace>
                  }
                >
                  ...
                  <Route
                    ...
                    element={<DocumentGeneratePage />}
                  />
                  <Route
                    path="*"
                    element={<Navigate to="/litigant" replace />}
                  />
                </Route>
                ...
                <Route
                  ...
                  element={
                    <ProtectedWorkspace
                      allowedRoles={["LAWYER"]}
                      message="Loading Lawyer Workspace..."
                    >
                      <DashboardLayout />
                    </ProtectedWorkspace>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedWorkspace
                      allowedRoles={["JUDGE"]}
                      message="Loading Judicial Workspace..."
                    >
                      <DashboardLayout />
                    </ProtectedWorkspace>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedWorkspace
                      allowedRoles={["POLICE"]}
                      message="Loading Police Dashboard..."
                    >
                      <DashboardLayout />
                    </ProtectedWorkspace>
                  }
                >
                  ...
                  <Route
                    path="investigations"
                    element={<PoliceInvestigationsPage />}
                  />
                  <Route
