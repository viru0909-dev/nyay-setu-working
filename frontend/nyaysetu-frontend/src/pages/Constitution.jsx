...
export default function Constitution() {
  ...
  const parts = useMemo(() => {
    return i18n.getResource(i18n.language, "constitution", "parts") || [];
  }, [i18n.language]);
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              ...
              >
                <Globe size={20} />
                {language === "en" ? t("readHindi") : t("readEnglish")}
              </button>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "0.75rem" }}>
                      <button
                        ...
                        style={{
                          padding: "0.75rem",
                          background: bookmarks.find(
                            (b) => b.number === selectedArticle.number,
                          )
                            ? "var(--color-primary)"
                            : "#F1F5F9",
                          border: "1px solid #E2E8F0",
                          borderRadius: "0.75rem",
                          color: bookmarks.find(
                            (b) => b.number === selectedArticle.number,
                          )
                            ? "white"
                            : "var(--color-primary)",
                      ...
                      >
                        ...
                        >
                          <Bookmark
                            size={20}
                            fill={
                              bookmarks.find((b) => b.number === article.number)
                                ? "var(--color-primary)"
                                : "none"
                            }
                          />
            ...
            {showAIChat && (
              ...
              >
                ...
                >
                  ...
                  <p
                    style={{ color: "#94a3b8", fontSize: "0.95rem", margin: 0 }}
                  >
                    {t("askQuestion")}
                  </p>
