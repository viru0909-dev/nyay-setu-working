      ...
      <div style={{ marginBottom: "2rem", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            >
              Advanced legal research and strategic consultation powered by
              Llama 3.1
            </p>
          </div>
        </div>
      ...
      >
                  ...
                  style={{
                    ...
                    border:
                      msg.role === "user"
                        ...
                        : "var(--border-glass-subtle)",
                    borderTopRightRadius:
                      msg.role === "user" ? "0.2rem" : "1.25rem",
                    borderTopLeftRadius:
                      msg.role === "assistant" ? "0.2rem" : "1.25rem",
                    whiteSpace: "pre-wrap",
                  }}
                >
              ...
              <div style={{ display: "flex", gap: "1rem" }}>
                ...
                >
                  <span style={{ color: "var(--text-secondary)" }}>
                    AI is researching legal precedents...
                  </span>
                </div>
              </div>
            )}
        ...
        >
          ...
          >
            ...
            >
              Trained on over 1.2 million Indian court proceedings and the
              latest Bharitya Nyaya Sanhita (BNS) updates.
            </p>
            <div
              style={{
                marginTop: "1rem",
