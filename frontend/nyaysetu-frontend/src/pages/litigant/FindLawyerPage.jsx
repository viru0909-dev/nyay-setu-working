...
const s = ["All", "Criminal Law", "Family Law", "Civil Law", "Corporate Law"];
const experiences = [
  "All",
  "5 years",
  "7 years",
...
console.log("FindLawyerPage rendered");
export default function FindLawyerPage() {
  ...
  const filtered = lawyers.filter((l) => {
    ...
    const matchSpecialization = filter === "All" || l.specialization === filter;

    const matchExperience =
      experienceFilter === "All" || l.experience === experienceFilter;

    const matchLocation =
      locationFilter === "All" || l.location === locationFilter;
    return (
      matchSearch && matchSpecialization && matchExperience && matchLocation
    );
  });
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  cursor:
                    lawyer.available && !requested.includes(lawyer.id)
                      ? "pointer"
                      : "not-allowed",
                  background: requested.includes(lawyer.id)
                    ? "#e8f5e9"
                    : lawyer.available
                      ? "var(--color-primary)"
                      : "var(--bg-glass-subtle)",
                  color: requested.includes(lawyer.id)
                    ? "#2e7d32"
                    : lawyer.available
                      ? "white"
                      : "var(--text-secondary)",
