...
export default function FindLawyerPage() {
  ...
  const filtered = lawyers.filter((l) => {
    ...
    const matchFilter = filter === "All" || l.specialization === filter;

    return matchSearch && matchFilter;
  });

  const sortedLawyers = [...filtered];
  ...
  if (sortBy === "cases") {
    sortedLawyers.sort((a, b) => b.cases - a.cases);
  }

  if (sortBy === "alphabetical") {
    sortedLawyers.sort((a, b) => a.name.localeCompare(b.name));
  }
    ...
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "2rem" }}>
      ...
      >
        ...
        >
          ...
          <option value="cases">Number of Cases (High → Low)</option>
