        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    {steps.map((step) => (
                        ...
                        >
                            <div style={{
                                ...
                                fontWeight: '700',
                                fontSize: '1rem',
                                color: step.number <= currentStep ? 'white' : '#64748b',
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <div style={{
                                    fontSize: '0.875rem',
                                    fontWeight: '600',
                                    color: step.number === currentStep ? '#c4b5fd' : step.number < currentStep ? '#8b5cf6' : '#64748b',
            ...
            <div style={{
                                    ...
                                    {['normal', 'urgent', 'critical'].map((level) => (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                borderRadius: '0.75rem',
                                                color: formData.urgency === level ? '#c4b5fd' : '#94a3b8',
                                                fontWeight: '600',
                                                cursor: 'pointer',
                ...
                {currentStep === 4 && (
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Case Type</h3>
                            ...
                            <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Case Title</h3>
                                <p style={{ fontSize: '1.125rem', fontWeight: '600', color: 'white' }}>{formData.title}</p>
                            </div>

                            <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Description</h3>
                                <p style={{ fontSize: '1rem', color: '#e2e8f0', lineHeight: '1.6' }}>{formData.description}</p>
                            </div>

                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                    <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Petitioner</h3>
                                    <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{formData.petitioner}</p>
                                </div>

                                <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                    <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Respondent</h3>
                                    <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{formData.respondent}</p>
                                </div>
                            </div>

                            <div style={{ padding: '1.5rem', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '1rem' }}>
                                <h3 style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Documents Uploaded</h3>
            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        padding: '1rem 2rem',
                        background: currentStep === 1 ? 'rgba(148, 163, 184, 0.1)' : 'rgba(139, 92, 246, 0.1)',
                        border: '1px solid rgba(139, 92, 246, 0.2)',
                        borderRadius: '0.75rem',
                        color: currentStep === 1 ? '#64748b' : '#c4b5fd',
                        fontWeight: '600',
