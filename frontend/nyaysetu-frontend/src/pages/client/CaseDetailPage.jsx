    ...
    return (
        <div>
            ...
            <div style={{
                ...
                <p style={{ fontSize: '1rem', color: '#94a3b8', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                    {caseData.description}
                </p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div>
                            <p style={{ fontSize: '0.8rem', color: '#64748b' }}>Case Type</p>
                            <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{caseData.caseType}</p>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div>
                            <p style={{ fontSize: '0.8rem', color: '#64748b' }}>Filed Date</p>
                            <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{formatDate(caseData.filedDate)}</p>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div>
                            <p style={{ fontSize: '0.8rem', color: '#64748b' }}>Assigned Judge</p>
                            <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{caseData.assignedJudge || 'Not assigned'}</p>
                        </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div>
                            <p style={{ fontSize: '0.8rem', color: '#64748b' }}>Next Hearing</p>
                            <p style={{ fontSize: '1rem', fontWeight: '600', color: 'white' }}>{formatDate(caseData.nextHearing) || 'To be scheduled'}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '1.1rem', color: 'white', fontWeight: '500' }}>{caseData.petitioner}</p>
                </div>
                <div style={{
                    background: 'rgba(30, 41, 59, 0.8)',
                    border: '1px solid rgba(139, 92, 246, 0.2)',
                    ...
                    <p style={{ fontSize: '1.1rem', color: 'white', fontWeight: '500' }}>{caseData.respondent}</p>
                </div>
            </div>
            ...
            {caseData.aiGeneratedSummary && (
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                        ...
                        <h3 style={{ fontSize: '1.1rem', fontWeight: '700', color: '#c4b5fd' }}>AI Case Summary</h3>
                    </div>
                    <pre style={{
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '700', color: '#34d399' }}>Next Steps</h3>
                </div>
                <ul style={{ color: '#e2e8f0', fontSize: '0.95rem', lineHeight: '1.8', paddingLeft: '1.5rem', margin: 0 }}>
