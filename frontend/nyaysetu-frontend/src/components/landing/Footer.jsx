...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    {
      label: t("common:header.nav.upcomingFeatures"),
      href: "/upcoming-features",
      isRoute: true,
    },
    {
      label: t("common:header.nav.constitution"),
      href: "/constitution",
      isRoute: true,
    },
    {
      label: t("common:header.nav.aiAssistant"),
      ...
      >
              ...
              {socialLinks.map((link) => (
                <motion.a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 0 18px ${link.color}`;
                  }}
                  onMouseLeave={(e) => {
        ...
        >
          ...
          >
            ...
            <FaHeart color="#ef4444" size={14} /> {t("landing:footer.by")}
          </p>
          <p
            style={{
              color: "rgba(255, 255, 255, 0.5)",
