...
# ── LLM resolution (lazy, for /chat only) ─────────────────────────────────────  # noqa
...
# ── Legal prompt template ──────────────────────────────────────────────────────  # noqa

LEGAL_PROMPT_TEMPLATE: str = """You are Vakil Friend, the AI legal assistant of Nyay Setu.  # noqa
You help Indian citizens understand their legal rights and navigate the judiciary.  # noqa
